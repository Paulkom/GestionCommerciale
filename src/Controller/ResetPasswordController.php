...
class ResetPasswordController extends AbstractController
{
    ...
    {
        $personnel = $this->entityManager->getRepository(Personnel::class)->findOneBy([
            'email' => $emailFormData,
        ]);
        ...
        $email = (new TemplatedEmail())
           ->from(new Address('contact@romastechnologie.com'))
           ->to(new Address($user->getPersonnel()->getEmail()))
